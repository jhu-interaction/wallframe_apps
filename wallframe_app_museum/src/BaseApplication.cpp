...
//        mWindow = mRoot->initialise(true, "MuseumApp Render Window");
...
//    }
    ...
    int w = 3920, h = 2200;
    std::string dimensions = "3920 x 2200" ;

    renderSystem->setConfigOption( "Video Mode", dimensions );
...
//    params["parentWindowHandle"] = getWindowHandle();
